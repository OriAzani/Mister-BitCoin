...
export class ContactService {
  ...
  //mock the server
  private _contacts: Contact[] = this.getContacts();
  ...
  public getContacts() {    
    let contacts = utils.loadFromStorage('contact');
    if (!contacts) {
      contacts = CONTACTS
      utils.storeToStorage('contact', contacts);
    }
    return contacts
  }
  ...
  public deleteContact(id: string) {
    ...
    utils.storeToStorage('contact' , this._contacts)
